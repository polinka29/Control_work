Пользователь вводит массив строк путем ввода, вывести на печать новый массив строк,
котрый меньше или равен 3 символам.
...
Условие if(Аrray[i].Length <= 3) проверяем равен ли массив 3м или меньше символам, счетчиком count перебираем.
